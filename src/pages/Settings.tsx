...
import { ArrowLeft, LayoutDashboard, PanelLeft, Globe, FlaskConical, Code2, UserCog } from 'lucide-react';
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-lg font-semibold">
                  {language === "en" ? "Account Settings" : "Kontoeinstellungen"}
                </h2>
              </div>
              <p className="text-sm text-muted-foreground">
                {language === "en"
                  ? "Manage your public display name and profile picture."
                  : "Verwalte deinen öffentlichen Anzeigenamen und dein Profilbild."}
              </p>
              <AccountSettings />
            </div>
          </Card>
