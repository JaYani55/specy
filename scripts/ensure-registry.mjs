...
if (!existsSync(HOOKS_REGISTRY_FILE)) {
  mkdirSync(PLUGINS_DIR, { recursive: true });
...
`, 'utf8');
  console.log('i  Created empty src/plugins/hooks-registry.ts');
}

if (!existsSync(PLUGIN_METADATA_FILE)) {
...
`, 'utf8');
  console.log('i  Created empty api/plugin-metadata.ts');
}
