...
Cross-cutting platform concerns: hosting, tenancy, core extensions.

| Document | Purpose |
|---|---|
| [`supabase-cloudflare-setup.md`](supabase-cloudflare-setup.md) | Supabase + Cloudflare Workers infrastructure setup guide |
